...
# download URLs
export PANEL_DL_URL="https://github.com/obscuraworks/panel/releases/latest/download/panel.tar.gz"
...
export GITHUB_BASE_URL=${GITHUB_BASE_URL:-"https://raw.githubusercontent.com/obscuraworks/pterodactyl-installer"}
...
welcome() {
  ...
  output ""
  output "Maintained by PT Obscuraworks Digital Indonesia"
