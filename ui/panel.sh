...
upgrade_summary() {
  print_brake 62
  output "Upgrade: Pterodactyl Panel -> Obscuraworks Panel"
  output ""
  output "This will:"
  output "  1. Put your panel into maintenance mode"
  output "  2. Download the latest Obscuraworks panel release"
...
run_upgrade() {
  output "Starting upgrade to Obscuraworks panel..."
...
handle_existing_installation() {
  ...
  echo ""
  output "[1] Upgrade existing panel to Obscuraworks Panel"
  ...
  case "$EXISTING_CHOICE" in
    1)
      upgrade_summary
      echo -e -n "\n* Confirm upgrade to Obscuraworks Panel? (y/N): "
...
goodbye_upgrade() {
  print_brake 62
  output "Obscuraworks Panel upgrade completed!"
  output ""
  output "Your panel has been upgraded to the latest Obscuraworks release."
  output "Your .env configuration and database remain intact."
  output ""
  output "Thank you for using Obscuraworks!"
  output "hello@obscuraworks.com | www.obscuraworks.org"
  print_brake 62
}
